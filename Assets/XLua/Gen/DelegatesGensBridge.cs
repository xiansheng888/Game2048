...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp0(UnityEngine.GameObject p0, UnityEngine.GameObject p1, UnityEngine.Collider p2)
		{
		...
		public void __Gen_Delegate_Imp1(UnityEngine.GameObject p0, UnityEngine.GameObject p1, UnityEngine.Collision p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(DelegateTriggerFun))
			{
			    return new DelegateTriggerFun(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(DelegateCollisionFun))
			{
			    return new DelegateCollisionFun(__Gen_Delegate_Imp1);
			}
