...
namespace XLua.CSObjectWrap
{
    ...
    public class FUNCWrap
    {
		public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginObjectRegister(typeof(FUNC), L, translator, 0, 0, 0, 0);
			Utils.EndObjectRegister(typeof(FUNC), L, translator, null, null, null, null, null);
			
			Utils.BeginClassRegister(typeof(FUNC), L, null, 13, 0, 0);

            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Awake", FUNC.Awake);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "OnEnable", FUNC.OnEnable);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Start", FUNC.Start);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "FixedUpdate", FUNC.FixedUpdate);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Update", FUNC.Update);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "LateUpdate", FUNC.LateUpdate);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "OnGUI", FUNC.OnGUI);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "OnDisable", FUNC.OnDisable);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "OnDestroy", FUNC.OnDestroy);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "OnApplicationFocus", FUNC.OnApplicationFocus);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "OnApplicationPause", FUNC.OnApplicationPause);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "OnApplicationQuit", FUNC.OnApplicationQuit);
            

			Utils.RegisterFunc(L, Utils.CLS_IDX, "__CastFrom", __CastFrom);
            
            Utils.EndClassRegister(typeof(FUNC), L, translator);
        }
        ...
        static int __CastFrom(RealStatePtr L)
		{
            ...
            {
                translator.PushFUNC(L, (FUNC)LuaAPI.xlua_tointeger(L, 1));
            }
			
            else if(lua_type == LuaTypes.LUA_TSTRING)
            {

			    if (LuaAPI.xlua_is_eq_str(L, 1, "Awake"))
                {
                    translator.PushFUNC(L, FUNC.Awake);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "OnEnable"))
                {
                    translator.PushFUNC(L, FUNC.OnEnable);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Start"))
                {
                    translator.PushFUNC(L, FUNC.Start);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "FixedUpdate"))
                {
                    translator.PushFUNC(L, FUNC.FixedUpdate);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Update"))
                {
                    translator.PushFUNC(L, FUNC.Update);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "LateUpdate"))
                {
                    translator.PushFUNC(L, FUNC.LateUpdate);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "OnGUI"))
                {
                    translator.PushFUNC(L, FUNC.OnGUI);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "OnDisable"))
                {
                    translator.PushFUNC(L, FUNC.OnDisable);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "OnDestroy"))
                {
                    translator.PushFUNC(L, FUNC.OnDestroy);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "OnApplicationFocus"))
                {
                    translator.PushFUNC(L, FUNC.OnApplicationFocus);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "OnApplicationPause"))
                {
                    translator.PushFUNC(L, FUNC.OnApplicationPause);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "OnApplicationQuit"))
                {
                    translator.PushFUNC(L, FUNC.OnApplicationQuit);
                }
				else
                {
                    return LuaAPI.luaL_error(L, "invalid string for FUNC!");
                }
            ...
            {
                return LuaAPI.luaL_error(L, "invalid lua type for FUNC! Expect number or string, got + " + lua_type);
            }
